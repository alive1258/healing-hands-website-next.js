...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Get in touch with Healing Hands to book a treatment, ask about our packages, or plan a visit to the spa.",
};
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Questions about a treatment, a package, or a gift card? Reach out and we&apos;ll get back to you within one business day."
        image="/images/wellness-placeholder-3.jpg"
        ...
        <div className="container grid lg:grid-cols-[1fr_1.2fr] gap-12">
          <div className="space-y-8">
            ...
            <div className="overflow-hidden rounded-2xl border border-brand-900/10">
              <iframe
                title="Healing Hands spa location"
