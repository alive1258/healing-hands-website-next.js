...
import { CONTACT_PHONE, MENU_ITEMS } from "../Navbar/menuItems";
        ...
        <div className="max-h-[calc(80vh-72px)] overflow-y-auto px-6 pb-24">
          <div className="space-y-4">
            ...
            <Link
              href="/contact"
              onClick={onClose}
              className="block w-full text-center bg-brand-600 text-white py-2.5 rounded-lg mt-2 font-semibold hover:bg-brand-700 transition"
            >
              Book Appointment
            </Link>
          </div>
